...
def show_csv(csv_path):
  ...
  # /home/duy/Documents/Competition/Video-Text-Retrieval/Database/Keyframes_L01/L01_V001/0001.jpg
  submit_csv['path'] = submit_csv.apply(lambda x: f'Database/Keyframes_{str(x[0])[:3]}/{x[0]}/{x[1]:04}', axis = 1)
